package com.wade.springbootexample.dao.impl;
...
import com.wade.springbootexample.rowmapper.OrderItemRowMapper;
import com.wade.springbootexample.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public void createOrderItems(Integer orderId, List<OrderItem> orderItemList) {
        // Using for loop insert every orderItem
...
//        }
        ...
        // Using batchUpdate insert orderItems, more efficient
        String sql = "INSERT INTO order_item(order_id, product_id, quantity, amount) " +
                "VALUES (:orderId, :productId, :quantity, :amount)";
